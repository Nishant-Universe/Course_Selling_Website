...
function Courses() {
  ...
  return (
    <div className="flex">
      ...
      <button
        className="md:hidden fixed top-4 left-4 z-20 text-3xl text-gray-800  bg-gradient-to-r from-blue-600 to-red-900"
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 h-screen bg-gradient-to-r from-blue-600 to-red-900  w-64 p-5 transform z-10 transition-transform duration-300 ease-in-out ${
      ...
      {/* Main content */}
      <main className="ml-0 md:ml- w-full  bg-gradient-to-r from-blue-900 to-red-900 p-10">
              ...
              {courses.map((course) => (
                ...
                >
                  ...
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <span className="text-green-600">90% off</span>
                  </div>
